        ...
        <div class="card-body">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Paket Saya Sesi</li>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="p-3 card-border" style="text-align:center;border-radius:10px">
                              ...
                              <?php if(count($upaketsoalmst->u_paket_soal_essay_dtl_r)>0): ?>
                                ...
                                <?php endif; ?>
                              <?php else: ?>
                                  <div><span style="font-size:36px;color:#4F46E5"><?php echo e($upaketsoalmst->set_nilai<=0 ? 0 : $upaketsoalmst->set_nilai); ?></span></div>
                              <?php endif; ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                      <div class="card-border p-3 br-10 list-nomor">
                        ...
                        <?php endif; ?>
                        <br>
                        <center class="mb-2"><?php echo e($upaketsoalmst->jenis_waktu==1 ? "Kategori" : "Sesi"); ?></center>
                        ...
                        <p><?php echo e($upaketktg->judul); ?></p>
                        <ul class="_soal nav nav-pills mb-0" id="pills-tab" role="tablist">
                          ...
                          <?php $__currentLoopData = $upaketsoalmst->u_paket_soal_essay_ktg_r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upaketktg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <p><?php echo e($upaketktg->judul); ?></p>
                          <ul class="_soal nav nav-pills mb-0" id="pills-tab" role="tablist">
                          <?php $__currentLoopData = $upaketktg->u_paket_soal_dtl_r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <!-- <li class="nav-item" role="presentation">
...
<?php echo $__env->make($extend, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1124801.cloudwaysapps.com/kgxqsgujwy/public_html/laravel/resources/views/user/detailhasilsesi.blade.php ENDPATH**/ ?>