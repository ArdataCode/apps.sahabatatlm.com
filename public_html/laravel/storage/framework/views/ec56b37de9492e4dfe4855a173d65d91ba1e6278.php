            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <div class="form-group">
                    <label for="judul_<?php echo e($key->id); ?>">Fitur<span class="bintang">*</span></label>
                    <input type="text" class="form-control" id="judul_<?php echo e($key->id); ?>" name="judul[]" placeholder="Fitur" value="<?php echo e($key->judul); ?>">
                </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_<?php echo e($key->id); ?>" class="form-horizontal">
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus fitur <?php echo e($key->judul); ?>?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <label for="judul_add">Fitur<span class="bintang">*</span></label>
                <input type="text" class="form-control" id="judul_add" name="judul_add" placeholder="Fitur">
              </div> 
...
<script>
  $(document).ready(function(){
    ...
    datatableeventsyarat("tabledata");
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuspaketfitur')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatepaketfitur')); ?>/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storepaketfitur')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketfitur.blade.php ENDPATH**/ ?>