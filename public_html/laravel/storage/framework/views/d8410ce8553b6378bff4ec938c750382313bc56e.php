...
<h1 class="m-0"><?php echo e($kategori->judul); ?></h1>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheadermenu'); ?>
<ol class="breadcrumb float-sm-right">
    <!-- <li class="breadcrumb-item">Bank Soal Pilihan Ganda</li> -->
    <li class="breadcrumb-item active"><a href="<?php echo e(url('paketkategori')); ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
</ol>
<?php $__env->stopSection(); ?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <span data-toggle="tooltip" data-placement="left" title="Tambah Subkategori">
                  ...
                  <tr>
                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        ...
                        <?php
                          $cekdata = App\Models\PaketMst::where('fk_paket_subkategori',$key->id)->get();
                        ?>
                        ...
                        <?php else: ?>
                          <span data-toggle="tooltip" data-placement="left" title="Harap hapus paket yang menggunakan subkategori ini terlebih dahulu">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <div class="form-group">
                    <label for="judul_<?php echo e($key->id); ?>">Subkategori<span class="bintang">*</span></label>
                    <input type="text" class="form-control" id="judul_<?php echo e($key->id); ?>" name="judul[]" placeholder="Subkategori" value="<?php echo e($key->judul); ?>">
                </div>
                <div class="form-group">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_<?php echo e($key->id); ?>" class="form-horizontal">
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus subkategori <?php echo e($key->judul); ?>?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="fk_paket_kategori" id="fk_paket_kategori" value="<?php echo e($id); ?>">
          <div class="modal-body">
              <!-- <div class="card-body"> -->
              <div class="form-group">
                <label for="judul_add">Subkategori<span class="bintang">*</span></label>
                <input type="text" class="form-control" id="judul_add" name="judul_add" placeholder="Subkategori">
              </div>
              <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuspaketsubkategori')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatepaketsubkategori')); ?>/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storepaketsubkategori')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketsubkategori.blade.php ENDPATH**/ ?>