        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                  <label for="pembahasan_add">Pembahasan <span class="bintang">(Opsional)</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1017870.cloudwaysapps.com/hnkjpyncjk/public_html/laravel/resources/views/master/mastersoal.blade.php ENDPATH**/ ?>