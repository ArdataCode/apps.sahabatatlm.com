...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('layout/adminlte3/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css')); ?>">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo e(url('/')); ?>" class="brand-link" style="font-size:1rem">
                <img src="<?php echo e(asset($template->logo_kecil)); ?>" style="max-height: 30px;" alt="Logo"
                    class="brand-image img-circle elevation-3">
                <span style="font-weight:500 !important;"
                    class="brand-text font-weight-light"><?php echo e($template->nama); ?></span>
            </a>
                ...
                <a href="./index3.html" class="nav-link">
                  ...
                  <p>Dashboard v3</p>
                        ...
                        <?php if(Auth::user()->user_level == 1): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(url('template')); ?>"
                                    class="nav-link <?php echo e($menu == 'template' ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('informasi')); ?>"
                                    class="nav-link <?php echo e($menu == 'informasi' ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(url('masterrekening')); ?>" class="nav-link <?php echo e($submenu == 'masterrekening' ? 'active' : ''); ?>">
                  ...
                  <p>
                    Rekening / E-Wallet
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('kategorisoal')); ?>"
                                            class="nav-link <?php echo e($submenu == 'kategorisoal' ? 'active' : ''); ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('paketkategori')); ?>"
                                            class="nav-link <?php echo e($submenu == 'paketkategori' ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(url('kategorisoalkecermatan')); ?>" class="nav-link <?php echo e($submenu == 'kategorisoalkecermatan' ? 'active' : ''); ?>">
                  ...
                  <p>
                    Bank Soal Kecermatan
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('paketsoalmst')); ?>"
                                            class="nav-link <?php echo e($submenu == 'paketsoalmst' ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(url('paketsoalkecermatan')); ?>" class="nav-link <?php echo e($submenu == 'paketsoalkecermatan' ? 'active' : ''); ?>">
                  ...
                  <p>
                    Paket Soal Kecermatan
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('paketmst')); ?>"
                                            class="nav-link <?php echo e($submenu == 'paketmst' ? 'active' : ''); ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('kodepotongan')); ?>"
                                            class="nav-link <?php echo e($submenu == 'kodepotongan' ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('user')); ?>"
                                    class="nav-link <?php echo e($menu == 'user' ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item <?php echo e($menu == 'transaksi' ? 'menu-open' : ''); ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('listtransaksi/paket')); ?>"
                                            class="nav-link <?php echo e($submenu == 'paket' ? 'active' : ''); ?>">
                                            <i class="fas fa-wallet"></i>
                                            <p>
                                                Paket
                                            </p>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align:center;padding:0px">
                            <a id="modal-body-href" target="_blank" href=""><img
                                    style="width:100%;height:auto" id="modal-body-image" src=""
                                    alt=""></a>
                        </div>
...
<?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/layouts/Adminlte3.blade.php ENDPATH**/ ?>