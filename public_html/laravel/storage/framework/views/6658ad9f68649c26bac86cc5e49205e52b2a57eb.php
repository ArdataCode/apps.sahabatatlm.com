                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="table-responsive mt-3">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Jumlah Soal</td>
                                    <td><?php echo e($key->paket_mst_r->total_soal); ?> Soal</td>
                                  </tr>
                                  <tr>
                            ...
                            <div class="modal-footer" style="justify-content:center">
                              <form method="post" id="formKerjakan_<?php echo e($key->id); ?>" class="form-horizontal">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="idpaketdtl[]" value="<?php echo e(Crypt::encrypt($idpaketdtl)); ?>">
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/paketsayadtl.blade.php ENDPATH**/ ?>