        ...
        <div class="card-body">
          ...
          <div class="row mt-3">
            ...
            <div class="_soal_content tab-content" id="pills-tabContent">
              ...
              <?php
              $x = \App\Models\UPaketSoalDtl::select('id','no_soal','soal','a','b','c','d','e')->where('fk_u_paket_soal_ktg',$datakategori->id)->get();
              ?>
              <?php $__currentLoopData = $x; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <?php $__currentLoopData = $dataloopessay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datakategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                $x = \App\Models\UPaketSoalEssayDtl::select('id','no_soal','soal','jawaban_user','jawaban_userfile')->where('fk_u_paket_soal_ktg',$datakategori->id)->get();
                ?>
                <?php $__currentLoopData = $x; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade <?php echo e($no==1 ? 'show active' : ''); ?>" id="pills-<?php echo e($key->id); ?>" role="tabpanel">
            ...
            <div class="card-border p-3 br-10">
              ...
              <ul class="_soal nav nav-pills mb-0" id="pills-tab" role="tablist">
                ...
                <?php $__currentLoopData = $dataloop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datakategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  $x = \App\Models\UPaketSoalDtl::select('id','jawaban_user','no_soal')->where('fk_u_paket_soal_ktg',$datakategori->id)->get();
                  ?>
                  <?php $__currentLoopData = $x; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php
                $x = \App\Models\UPaketSoalEssayDtl::select('id','no_soal','jawaban_user','jawaban_userfile')->where('fk_u_paket_soal_ktg',$datakategori->id)->get();
                ?>
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/sahabatatlm.com/public_html/laravel/resources/views/user/ujian.blade.php ENDPATH**/ ?>