...
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a class="_kembali" href="<?php echo e(url('paketmst')); ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
</ol>
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-10">: <?php echo e($datamst->judul); ?></div>
                </div>
                <!-- <div class="row">
                    <div class="col-sm-2">Tanggal</div>
                    <div class="col-sm-10">: <?php echo e(tglIndo($datamst->mulai)); ?> - <?php echo e(tglIndo($datamst->selesai)); ?></div>
                </div> -->
              </div>
              <!-- <div class="card-header">
              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="10%"><?php echo e($key->judul); ?></td>
                    <td width="15%" class="_align_center"><a target="_blank" href="<?php echo e($key->jenis==1 ? $key->link : asset($key->link)); ?>">Link/File</a></td>
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                  ...
                  <select name="jenis[]" id="jenis_<?php echo e($key->id); ?>" class="jenismateri form-control" idjenis="<?php echo e($key->id); ?>">
                    <option value=""></option>
                    <option value="1" <?php echo e($key->jenis==1 ? 'selected' : ''); ?>>Video</option>
                    <option value="2" <?php echo e($key->jenis==2 ? 'selected' : ''); ?>>PDF</option>
                  </select>
                </div>

                <div class="form-group <?php echo e($key->jenis==1 ? '' : 'hide'); ?> video_link_<?php echo e($key->id); ?>">
                  <label for="link_<?php echo e($key->id); ?>">Link<span class="bintang">*</span></label>
                  <input type="text" class="form-control" id="link_<?php echo e($key->id); ?>" name="link[]" placeholder="Link" value="<?php echo e($key->link); ?>">
                </div>

                <div class="form-group <?php echo e($key->jenis==2 ? '' : 'hide'); ?> materi_link_<?php echo e($key->id); ?>">
                  <label>Materi<span class="bintang">*</span> <span class="input-keterangan">(pdf)</span></label>
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="input-pdf custom-file-input" name="materi[]" id="materi_<?php echo e($key->id); ?>" idlabel="label-materi-<?php echo e($key->id); ?>">
                      <label id="label-materi-<?php echo e($key->id); ?>" class="custom-file-label">Choose file</label>
                    </div>
                  </div>
                </div> 
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_<?php echo e($key->id); ?>" class="form-horizontal">
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus <?php echo e($key->judul); ?>?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
              <input type="hidden" class="form-control" id="fk_paket_mst" name="fk_paket_mst" value="<?php echo e($idmst); ?>">
              ...
              <div class="form-group hide materi_link_add">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="input-pdf custom-file-input" name="materi_add" id="materi_add" idlabel="label-materi-add">
...
<script>
  $(document).ready(function(){
    ...
    //     });
    //     $.ajax({
    //         url: '<?php echo e(url("getPaketSoal")); ?>/<?php echo e($idmst); ?>',
    //         type: 'POST',
    //         dataType: "JSON",
    //         data: {
    //             "val":val
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuspaketmateri')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatepaketmateri')); ?>/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storepaketmateri')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketmateri.blade.php ENDPATH**/ ?>