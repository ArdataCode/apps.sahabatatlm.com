            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control int" id="kkm_<?php echo e($key->id); ?>" name="kkm[]" placeholder="Passing Grade Perkategori" value="<?php echo e($key->kkm); ?>">
                </div> 
                <div class="<?php echo e($datamst->jenis_waktu==2 ? '' : 'd-none'); ?>">
                  <div class="form-group">
          ...
          <div class="modal-body">
              ...
              <div class="<?php echo e($datamst->jenis_waktu==2 ? '' : 'd-none'); ?>">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control int" id="waktu_add" name="waktu_add" placeholder="Waktu Pengerjaan" value="1">
                </div>
                <div class="form-group">
                  <label for="countdown_add">Countdown (Detik)<span class="bintang">*</span></label>
                  <input type="text" class="form-control int" id="countdown_add" name="countdown_add" placeholder="Countdown" value="1">
                </div>
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/sahabatatlm.com/public_html/laravel/resources/views/master/paketsoalktg.blade.php ENDPATH**/ ?>