                ...
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        <span data-toggle="tooltip" data-placement="left" title="Subkategori">
                          <a href="<?php echo e(url('paketsubkategori')); ?>/<?php echo e($key->id); ?>" class="btn btn-sm btn-outline-info"><i class="fas fa-th-list"></i></a>
                        </span>
                        ...
                        <?php
                          $cekdata = App\Models\PaketSubkategori::where('fk_paket_kategori',$key->id)->get();
                        ?>
                        ...
                        <?php else: ?>
                          <span data-toggle="tooltip" data-placement="left" title="Harap hapus subkategori terlebih dahulu">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <div class="form-group">
                    <label for="judul_<?php echo e($key->id); ?>">Kategori<span class="bintang">*</span></label>
                    <input type="text" class="form-control" id="judul_<?php echo e($key->id); ?>" name="judul[]" placeholder="Kategori" value="<?php echo e($key->judul); ?>">
                </div>
                <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
              <div class="form-group">
                <label for="judul_add">Kategori<span class="bintang">*</span></label>
                <input type="text" class="form-control" id="judul_add" name="judul_add" placeholder="Kategori">
              </div>
              <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuspaketkategori')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatepaketkategori')); ?>/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storepaketkategori')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketkategori.blade.php ENDPATH**/ ?>