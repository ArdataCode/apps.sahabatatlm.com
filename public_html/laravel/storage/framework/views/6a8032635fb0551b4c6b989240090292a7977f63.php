            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5 mt-4">
              ...
              <?php echo csrf_field(); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-sm angka" id="no_wa" name="no_wa" placeholder="08123xxxxxx" aria-label="08123xxxxxx">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <option value=""></option>
                    <?php $__currentLoopData = referrer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($refer[0]); ?>"><?php echo e($refer[1]); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Sudah punya akun? <a href="<?php echo e(url('login')); ?>" class="text-primary">Masuk Sekarang</a>
                </div>
              </form>
            </div>
          </div>
...
<script>
    $(document).ready(function(){
        ...
        // });
        getSemuaKota('provinsi','kabupaten','<?php echo e(url("/getKabupaten")); ?>','<?php echo e(asset("/image/global/loading.gif")); ?>');
        ...
        $('#formRegister').validate({
            ...
            submitHandler: function () {
              ...
              var url = "<?php echo e(url('/storeregister')); ?>";
              $.ajaxSetup({
                  headers: {
                  ...
                  success: function (response) {
                      ...
                      Swal.fire({
                          ...
                          showConfirmButton: false
                              ...
                              reload_url(3000,"<?php echo e(url('/login')); ?>");
                      }else{
                      Swal.fire({
                          title: response.message,
                          icon: 'error',
...
<?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/auth/register.blade.php ENDPATH**/ ?>