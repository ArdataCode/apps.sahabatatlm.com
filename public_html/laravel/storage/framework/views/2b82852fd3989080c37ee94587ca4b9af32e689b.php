        ...
        <div class="card-body">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Checkout & Pembayaran</li>
            </ol>
          </nav>
          <p class="card-description">
            <h3 class="font-weight-bold"><b>Checkout & Pembayaran</b></h3>
          </p>
          <div class="row mt-4 row-atas">
            ...
            <h4 class="mt-3"><b>Pilih Metode Pembayaran</b></h4>
             <div class="row">
               <?php $__empty_1 = true; $__currentLoopData = $channel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
               <div class="col-12 col-md-4 col-lg-4 d-flex align-items-stretch mt-3 hover-box" channel="<?php echo e($key->kode); ?>" namachannel="<?php echo e($key->nama); ?>">
                <div class="card w-100">
                  <div class="card-body shadow" style="min-height: 200px; padding: 1rem;border-radius:20px">
                    <div class="d-flex mb-2">
                      <div class="mr-auto text-left text-primary pr-2 payment-name"><?php echo e($key->nama); ?></div>
                    </div>
                    <div class="text-center"><img src="<?php echo e($key->img); ?>" alt="" class="img-fluid" style="height: 35px;object-fit:contain"></div>
                    <p class="biaya mt-3 mb-0">Biaya : <?php echo e($key->biaya); ?></p>
            ...
            <div class="col-md-5 col-bawah">
                  <div class="card card-border border-top">
                    <div class="card-body">
                        ...
                        <?php echo csrf_field(); ?>
                        <center><h4><b>Kode voucher promo<br>(apabila ada)</b></h4></center>
                        <hr>
                        ...
                        <button id="btn-cek-kode" type="submit" class="btn btn-md btn-block btn-primary">Gunakan</button>
                        </form>
                    </div>
                  </div>
                  <div class="card card-border mt-3 border-top">
                    <div class="card-body" style="text-align:left">
                      ...
                      <label for="">Nama Paket</label>
                        <input type="text" class="form-control" placeholder="Nama Paket" style="color:#A95CFF;border-color:#A95CFF" value="<?php echo e($paket->judul); ?>" readonly>
...
var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
  ...
  $(document).ready(function(){
          ...
          Swal.fire({
            ...
            html: "Paket : <b><?php echo e($paket->judul); ?></b><br>Total Pembayaran : <b>"+total+"</b><br>Metode Pembayaran : <b>"+namachannel+"</b>",
            // icon: 'warning',
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                  ...
                  idpromo:idpromo,
                  channel:channel,
                  urlpaket:"<?php echo e(url()->full()); ?>"
                  },
                  url: '<?php echo e(url("createordertripay")); ?>',
                  dataType: "json",
                  cache: false,
                  beforeSend: function () {
                          $.LoadingOverlay("show", {
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/checkout.blade.php ENDPATH**/ ?>