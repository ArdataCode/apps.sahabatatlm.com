...
<h1 class="m-0">Kategori Bank Soal Essay</h1>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheadermenu'); ?>
<ol class="breadcrumb float-sm-right">
    <!-- <li class="breadcrumb-item">Bank Soal Essay</li> -->
                ...
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="1%" class="_align_center">
                        <?php
                            $cekjumlahsoal = App\Models\MasterSoalEssay::where('fk_kategori_soal_essay','=',$key->id)->get();
                        ?>
                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        <span data-toggle="tooltip" data-placement="left" title="Bank Soal">
                          <a href="<?php echo e(url('mastersoalessay')); ?>/<?php echo e($key->id); ?>" class="btn btn-sm btn-outline-info"><i class="fas fa-th-list"></i></a>
                        </span>
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuskategorisoalessay')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatekategorisoalessay')); ?>/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storekategorisoalessay')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1017870.cloudwaysapps.com/hnkjpyncjk/public_html/laravel/resources/views/master/kategorisoalessay.blade.php ENDPATH**/ ?>