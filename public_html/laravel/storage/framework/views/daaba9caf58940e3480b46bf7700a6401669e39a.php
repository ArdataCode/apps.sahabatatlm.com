                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        ...
                        <span data-toggle="tooltip" data-placement="left" title="Detail Paket">
                          <a href="<?php echo e(url('paketdtl')); ?>/<?php echo e($key->id); ?>" class="btn btn-sm btn-outline-success"><i class="fas fa-th-list"></i></a>
                        </span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketmst.blade.php ENDPATH**/ ?>