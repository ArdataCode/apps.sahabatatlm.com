...
<?php $__env->startSection('contentheadermenu'); ?>
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a class="_kembali" href="<?php echo e(url('paketsoalmst')); ?>"><i class="fa fa-arrow-left"
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/paketsoalktg/<?php echo e($idpaketmst); ?>/export" download class="btn btn-sm btn-success"
                    ...
                    <form method="post" id="formData_<?php echo e($key->id); ?>" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="fk_kategori_soal_<?php echo e($key->id); ?>">Kategori Soal<span
                                        class="bintang">*</span></label>
                                <input readonly type="text" class="form-control"
                                    id="fk_kategori_soal_<?php echo e($key->id); ?>" name="fk_kategori_soal[]"
                                    placeholder="Kategori Soal" value="<?php echo e($key->kategori_soal_r->judul); ?>">
                            </div>
                            <div class="form-group" style="display:none">
                                <label for="kkm_<?php echo e($key->id); ?>">KKM Perkategori<span
                                        class="bintang">*</span></label>
                                <input type="hidden" class="form-control int" id="kkm_<?php echo e($key->id); ?>"
                                    name="kkm[]" placeholder="KKM Perkategori" value="<?php echo e($key->kkm); ?>"
                                    <?php echo e($datamst->jenis_penilaian == 1 ? 'max=100' : ''); ?>>
                            </div>
                            <!-- /.form-group -->
                            <!-- </div> -->
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" id="_formData" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        <!-- <div class="card-body"> -->
                        <input type="hidden" class="form-control" id="fk_paket_soal_mst" name="fk_paket_soal_mst"
                            value="<?php echo e($idpaketmst); ?>">

                        <div class="form-group">
                            <label for="fk_kategori_soal_add">Kategori Soal<span class="bintang">*</span></label>
                            <select class="form-control kategorisoal" name="fk_kategori_soal_add"
                                id="fk_kategori_soal_add">
                                <option value=""></option>
                        ...
                        <div class="form-group" style="display:none">
                            ...
                            <input type="hidden" class="form-control int" id="kkm_add" name="kkm_add"
                                placeholder="KKM Perkategori" value="50"
                                <?php echo e($datamst->jenis_penilaian == 1 ? 'max=100' : ''); ?>>
                        </div>
                        <!-- <div class="card-body"> -->
                        <!-- /.form-group -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-hapus', function(e) {
                ...
                var url = "<?php echo e(url('/hapuspaketsoalktg')); ?>/" + idform;
                $.ajaxSetup({
                    headers: {
            ...
            $(document).on('click', '.btn-submit-data', function(e) {
                ...
                $('#formData_' + idform).validate({
                    ...
                    submitHandler: function() {
                        ...
                        var url = "<?php echo e(url('/updatepaketsoalktg')); ?>/" + idform;
                        $.ajaxSetup({
                            headers: {
            ...
            $('#_formData').validate({
                ...
                submitHandler: function() {
                    ...
                    var url = "<?php echo e(url('storepaketsoalktg')); ?>";
                    $.ajaxSetup({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        }
...
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketsoalktg.blade.php ENDPATH**/ ?>