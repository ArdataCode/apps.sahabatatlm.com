...
<style>
  ...
  .border-top{
    ...
    border-top: 6px solid #22abdf !important;
  }
          ...
          <div class="row mt-4">
                      ...
                      <div style="border: 1px solid #106571;border-radius:8px;overflow: hidden;">
                        <div class="row">
                          <div class="col-4 col-lg-3 col-md-4 bg-primary-custom" style="justify-content: center;padding-right:0px;display: flex;align-items: center;">
                            <img class="img-lock" src="<?php echo e(asset('image/global/lock-white.png')); ?>" alt="">
                          </div>
                          <div class="col-8 col-lg-9 col-md-8" style="align-items:center;display: grid;">
                            <h5 style="margin-bottom:0px"><b><?php echo e($key->paket_mst_r->judul); ?></b></h5>
            ...
            <div class="col-md-4">
              <div class="bg-harga-beli p-4">
                  ...
                  <?php if(!$ceksudahbeli): ?>
                  <a href="<?php echo e(url('checkout')); ?>/<?php echo e(Crypt::encrypt($paket->id)); ?>" class="custom-buttom"><img src="<?php echo e(asset('image/global/btn-beli-paket.png')); ?>" class="img-btn-beli" alt=""></a>
                  <?php else: ?>
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/belipaketdetail.blade.php ENDPATH**/ ?>