              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="1%" class="_align_center"><?php echo e($key->paket_mst_r->total_soal); ?></td>
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <div class="form-group">
                    <label for="fk_kategori_soal_<?php echo e($key->id); ?>">Paket Latihan<span class="bintang">*</span></label>
                    <input readonly type="text" class="form-control" id="fk_paket_soal_<?php echo e($key->id); ?>" name="fk_paket_soal[]" placeholder="Paket Soal" value="<?php echo e($key->fk_paket_soal_mst); ?>">
                </div>            
                <!-- /.form-group -->
              <!-- </div> -->
            </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_<?php echo e($key->id); ?>" class="form-horizontal">
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus paket latihan <?php echo e($key->paket_mst_r->judul); ?>?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <select class="form-control mapel" name="fk_mapel_mst_add" id="fk_mapel_mst_add">
                      <option value=""></option>
                      <?php $__currentLoopData = $datamapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($mapel->id); ?>"><?php echo e($mapel->judul); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
              <!-- <div class="card-body"> -->
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "<?php echo e(url('/hapuseventdtl')); ?>/"+idform;
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
    ...
    //         var url = "<?php echo e(url('/updatememberdtl')); ?>/"+idform;
    //         $.ajaxSetup({
    //             headers: {
    //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    //             }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('storeeventdtl')); ?>";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/master/paketdtl.blade.php ENDPATH**/ ?>