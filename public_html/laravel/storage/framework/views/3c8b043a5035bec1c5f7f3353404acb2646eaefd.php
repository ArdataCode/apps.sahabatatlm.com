                  ...
                  <div id="menunggu" class="tab-pane active"><br>
                        ...
                        <div class="row mb-3">
                          <div class="col-md-9">
                              ...
                              <?php if($key->channel_r): ?>
                              <div class="row mt-3 mb-3" style="align-items:center">
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    <img src="<?php echo e($key->channel_r->img); ?>" alt="" width="100%">
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                  <p><?php echo e($key->channel_r->nama); ?></p>
                                  <p>Total Pembayaran : <?php echo e(formatRupiahCekGratis($key->harga)); ?></p>
                                  <p style="margin-bottom:0px">Batas Pembayaran : <span class="text-danger"><?php echo e(Carbon\Carbon::parse($key->expired)->translatedFormat('l, d F Y , H:i:s')); ?> WIB</span></p>
                                </div>
                              </div>
                              <?php else: ?>
                              <p>Total Pembayaran : <?php echo e(formatRupiahCekGratis($key->harga)); ?></p>
                        ...
                        <div class="row mb-3">
                          <div class="col-md-8">
                              ...
                              <div class="row mt-3 mb-3" style="align-items:center">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                  <p><?php echo e($key->channel_r->nama); ?></p>
                                  <p style="margin-bottom:0px">Total Pembayaran : <?php echo e(formatRupiahCekGratis($key->harga)); ?></p>
                                  <!-- <p style="margin-bottom:0px">Batas Pembayaran : <span class="text-danger"><?php echo e(Carbon\Carbon::parse($key->expired)->translatedFormat('l, d F Y , H:i:s')); ?> WIB</span></p> -->
                                </div>
                              </div>
                              <?php else: ?>
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/pembelian.blade.php ENDPATH**/ ?>