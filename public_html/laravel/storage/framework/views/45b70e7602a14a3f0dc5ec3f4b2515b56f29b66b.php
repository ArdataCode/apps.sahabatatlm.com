        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <a target="_blank" href="<?php echo e(url('rankingpesertaexport')); ?>/<?php echo e(Crypt::encrypt($datapaket->id)); ?>" class="btn btn-md btn-success"><i class="fas fa-file-excel"></i> Export Data</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/sahabatatlm.com/public_html/laravel/resources/views/master/rankingpeserta.blade.php ENDPATH**/ ?>