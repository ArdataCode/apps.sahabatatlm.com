                ...
                <div class="tab-content tab-hasil-ujian">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            <div class="p-3 card-border" style="text-align:center;border-radius:10px">
                              <?php  
                                $getpoint = App\Models\UPaketSoalDtl::select('max_point')->where('fk_u_paket_soal_mst',$upaketsoalmst->id)->sum('max_point');
                              ?>
                              <h4>SKOR AKHIR</h4>
                              <div class="mb-3"><span style="font-size:36px;color:#4F46E5"><?php echo e($upaketsoalmst->point<=0 ? 0 : $upaketsoalmst->point); ?></span> dari <?php echo e($getpoint); ?></div>
                              <h6>Keterangan</h6>
                              <?php if($upaketsoalmst->point < $upaketsoalmst->kkm): ?>
                                <div class="badge badge-danger badge-pill"><h5 class="mb-0 p-1">Tidak Lulus</h5></div>
                              <?php else: ?>
                                <div class="badge badge-success badge-pill"><h5 class="mb-0 p-1">Lulus</h5></div>
                              <?php endif; ?>
                            </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="_soal_content tab-content" id="pills-tabContent">
                      ...
                      <div class="tab-pane-soal tab-pane fade <?php echo e($key->no_soal==1 ? 'show active' : ''); ?>" id="pills-<?php echo e($key->id); ?>" role="tabpanel">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='a' && $upaketsoalmst->bagi_jawaban==1 ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='a' ? '_form-check-user' : ''); ?>">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='b' && $upaketsoalmst->bagi_jawaban==1 ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='b' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                            ...
                            <?php if($key->c): ?>
                            <div class="form-check <?php echo e($key->jawaban=='c' && $upaketsoalmst->bagi_jawaban==1 ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='c' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                            ...
                            <?php if($key->d): ?>
                            <div class="form-check <?php echo e($key->jawaban=='d' && $upaketsoalmst->bagi_jawaban==1 ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='d' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                            ...
                            <?php if($key->e): ?>
                            <div class="form-check <?php echo e($key->jawaban=='e' && $upaketsoalmst->bagi_jawaban==1 ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='e' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='a' ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='a' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input _radio" disabled idpaketdtl="<?php echo e($key->id); ?>" name="radio_<?php echo e($key->id); ?>" value="a">
                                <i class="input-helper"></i></label>
                                <div class="_pilihan">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='b' ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='b' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input _radio" disabled idpaketdtl="<?php echo e($key->id); ?>" name="radio_<?php echo e($key->id); ?>" value="b">
                                <i class="input-helper"></i></label>
                                <div class="_pilihan">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='c' ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='c' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input _radio" disabled idpaketdtl="<?php echo e($key->id); ?>" name="radio_<?php echo e($key->id); ?>" value="c">
                                <i class="input-helper"></i></label>
                                <div class="_pilihan">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='d' ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='d' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input _radio" disabled idpaketdtl="<?php echo e($key->id); ?>" name="radio_<?php echo e($key->id); ?>" value="d">
                                <i class="input-helper"></i></label>
                                <div class="_pilihan">
                            ...
                            <div class="form-check <?php echo e($key->jawaban=='e' ? '_form-check-success' : '_form-check-danger'); ?> <?php echo e($key->jawaban_user=='e' ? '_form-check-user' : ''); ?>">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input _radio" disabled idpaketdtl="<?php echo e($key->id); ?>" name="radio_<?php echo e($key->id); ?>" value="e">
                                <i class="input-helper"></i></label>
                                <div class="_pilihan">
                          ...
                          <h5><b>Pembahasan</b> : <br><?php echo $key->pembahasan; ?></h5>
                          <?php endif; ?>
                          </div>
                    ...
                    <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                      <div class="card-border p-3 br-10">
                        ...
                        <ul class="_soal nav nav-pills mb-0" id="pills-tab" role="tablist">
                          ...
                          <li class="nav-item" role="presentation">
                            <button id="btn_no_soal_<?php echo e($key->id); ?>" class="
                            ...
                            <?php else: ?>
                                _kosong
                            <?php endif; ?>
                            nav-link nav-link-soal <?php echo e($key->no_soal==1 ? 'active' : ''); ?>" data-bs-toggle="pill" data-bs-target="#pills-<?php echo e($key->id); ?>" type="button" role="tab" aria-selected="true"><?php echo e($key->no_soal); ?></button>
                          </li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                      </div>
...
<?php echo $__env->make($extend, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/detailhasil.blade.php ENDPATH**/ ?>