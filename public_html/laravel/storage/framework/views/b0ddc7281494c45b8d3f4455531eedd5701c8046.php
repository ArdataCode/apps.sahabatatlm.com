...
<body>
    <div style="text-align:right">  
        <p style="font-size:12px"><i><?php echo e(Carbon\Carbon::now()->translatedFormat('l, d F Y , H:i:s')); ?></i></p>
    </div>
    ...
    <?php if(count($paketsoalktg)>0): ?>
    <center><h3 style="margin-bottom:5px">Soal Pilihan Ganda</h3></center>
    <?php endif; ?>
...
</html><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/pdf/SoalPilGan.blade.php ENDPATH**/ ?>