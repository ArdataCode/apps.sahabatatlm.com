          ...
          <div class="col-md-4 col-sm-4">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <?php if(Auth::user()->photo=='' || Auth::user()->photo==NULL): ?>
                      <img class="profile-user-img img-fluid img-circle"
                       src="<?php echo e(asset('image/global/unknown_user.png')); ?>"
                       alt="User Profile Picture">
                  <?php else: ?>
                      <a href="#" onclick="modalImage('<?php echo e(ucfirst(Auth::user()->name)); ?>','<?php echo e(asset(Auth::user()->photo)); ?>')"><img class="profile-user-img img-fluid img-circle"
                       src="<?php echo e(asset(Auth::user()->photo)); ?>"
                ...
                <!-- <p class="text-muted text-center"><?php echo e(ucfirst(Auth::user()->nik)); ?></p> -->

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Jenis Kelamin</b>
                    <a class="float-right">
                      <?php if(Auth::user()->jenis_kelamin=='l'): ?>
                          Laki-laki
                      <?php elseif(Auth::user()->jenis_kelamin=='p'): ?>
                          Perempuan
                      <?php else: ?>
                          -
                      <?php endif; ?>
                  ...
                  <!-- <li class="list-group-item">
                    <b>Tanggal Lahir</b> <a class="float-right"><?php echo e(tglIndo(Auth::user()->ttl)); ?></a>
                  </li> -->
                  <li class="list-group-item">
                  ...
                  <div class="active tab-pane" id="tabsettings">
                    ...
                    <?php echo csrf_field(); ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="name" type="text" class="form-control" id="name" placeholder="Name" value="<?php echo e(Auth::user()->name); ?>"> 
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea name="alamat" id="alamat" rows="5" class="form-control" placeholder="Alamat"><?php echo e(Auth::user()->alamat); ?></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            ...
                            <div class="input-group-append">
                              <button type="button" class="input-group-text" onclick="modalImage('<?php echo e(ucfirst(Auth::user()->name)); ?>','<?php echo e(asset(Auth::user()->photo)); ?>')">Lihat</button>
                            </div>
                            <?php endif; ?>
                          </div> 
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/profil/UserProfil.blade.php ENDPATH**/ ?>