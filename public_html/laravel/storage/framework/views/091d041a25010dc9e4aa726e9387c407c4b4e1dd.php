...
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a class="_kembali" href="<?php echo e(url('mastersoal')); ?>/<?php echo e($idkategori); ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
</ol>
<?php $__env->stopSection(); ?>
              ...
              <form method="post" id="formData" class="form-horizontal">
                <?php echo csrf_field(); ?>
                      ...
                      <div class="form-group">
                          ...
                          <textarea id="a" name="a[]" rows="2" class="form-control content_" placeholder="Pilihan A"><?php echo $data->a; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="point_a">Point Pilihan A<span class="bintang">*</span></label>
                        <input type="number" class="form-control int" id="point_a" name="point_a[]" placeholder="Point Pilihan A" value="<?php echo e($data->point_a); ?>">
                      </div>
                      <div class="form-group">
                          <label for="b">Pilihan B<span class="bintang">*</span></label>
                          <textarea id="b" name="b[]" rows="2" class="form-control content_" placeholder="Pilihan B"><?php echo $data->b; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="point_b">Point Pilihan B<span class="bintang">*</span></label>
                        <input type="number" class="form-control int" id="point_b" name="point_b[]" placeholder="Point Pilihan B" value="<?php echo e($data->point_b); ?>">
                      </div>
                      <div class="form-group">
                          <label for="c">Pilihan C <span class="bintang">(Opsional)</span></label>
                          <textarea id="c" name="c[]" rows="2" class="form-control content_" placeholder="Pilihan C"><?php echo $data->c; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="point_c">Point Pilihan C<span class="bintang">*</span></label>
                        <input type="number" class="form-control int" id="point_c" name="point_c[]" placeholder="Point Pilihan C" value="<?php echo e($data->point_c); ?>">
                      </div>
                      <div class="form-group">
                          <label for="d">Pilihan D <span class="bintang">(Opsional)</span></label>
                          <textarea id="d" name="d[]" rows="2" class="form-control content_" placeholder="Pilihan D"><?php echo $data->d; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="point_d">Point Pilihan D<span class="bintang">*</span></label>
                        <input type="number" class="form-control int" id="point_d" name="point_d[]" placeholder="Point Pilihan D" value="<?php echo e($data->point_d); ?>">
                      </div>
                      <div class="form-group">
                          <label for="e">Pilihan E <span class="bintang">(Opsional)</span></label>
                          <textarea id="e" name="e[]" rows="2" class="form-control content_" placeholder="Pilihan E"><?php echo $data->e; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="point_e">Point Pilihan E<span class="bintang">*</span></label>
                        <input type="number" class="form-control int" id="point_e" name="point_e[]" placeholder="Point Pilihan E" value="<?php echo e($data->point_e); ?>">
                      </div>
                    
                      <div class="form-group">
                          <label for="pembahasan">Pembahasan <span class="bintang">(Opsional)</span></label>
                          <textarea name="pembahasan[]" id="pembahasan" rows="5" class="form-control content_" placeholder="Pembahasan"><?php echo $data->pembahasan; ?></textarea>  
                      </div>  
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" id="jawaban" name="jawaban[]">
                              ...
                              <option value="<?php echo e($key[0]); ?>" <?php echo e($key[0]==$data->jawaban ? 'selected' : ''); ?>><?php echo e($key[1]); ?></option>
...
<!-- <script src="https://cdn.tiny.cloud/1/0twnfvrzobjdj82mvj8h3afdp101vxtvzge7eiqrbb0gwmw2/tinymce/6/tinymce.min.js"></script> -->
<script>
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        $('#formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "<?php echo e(url('/updatemastersoal')); ?>/<?php echo e($data->id); ?>";
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == true) {
                        ...
                        reload_url(1000,"<?php echo e(url('mastersoal')); ?>/<?php echo e($idkategori); ?>");
                    }else{
                      Swal.fire({
                          html: response.message,
                          icon: 'error',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Adminlte3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1124801.cloudwaysapps.com/kgxqsgujwy/public_html/laravel/resources/views/master/editsoal.blade.php ENDPATH**/ ?>