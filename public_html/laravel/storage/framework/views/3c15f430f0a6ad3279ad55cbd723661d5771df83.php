  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card card-border">
        ...
        if ($cekdata) {
            // Menggunakan kolom updated_at sebagai tanggal transaksi
            $tanggalTransaksi = Carbon\Carbon::parse($cekdata->updated_at);
            $masaAktif1Tahun = $tanggalTransaksi->copy()->addYear();
        }
    ?>
    <?php if($cekdata): ?>
        <p>Berlaku hingga:<br><?php echo e(tglIndo($masaAktif1Tahun)); ?></p>
    <?php else: ?>
        <p>Berlaku hingga:<br>Data tidak ditemukan</p>
    <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.Skydash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u726706882/domains/apps.sahabatatlm.com/public_html/laravel/resources/views/user/paketsaya.blade.php ENDPATH**/ ?>