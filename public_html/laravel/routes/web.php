...
Route::delete('/hapuspeserta/{id}', [App\Http\Controllers\PaketSoalMstController::class, 'destroy'])->name('hapuspeserta');
...
Route::middleware([IsAdminOrAff::class])->group(function () {
    ...
    Route::get('/user/export', [App\Http\Controllers\UserListController::class, 'excel']);
...
Route::middleware([IsAdmin::class])->group(function () {
    ...
    Route::get('/rankingpeserta/{id}/export', [App\Http\Controllers\PaketSoalMstController::class, 'rankingpesertaExport']);
    Route::post('rankingpeserta/{id}/tampilkan', [App\Http\Controllers\PaketSoalMstController::class, 'tampilkanJawaban'])->name("tampilkanJawaban");

    Route::get('/jawabanPeserta/{id}/export', [App\Http\Controllers\PaketSoalMstController::class, 'jawabanPesertaExport']);
    ...
    Route::get('/paketsoalktg/{id}/export', [App\Http\Controllers\PaketSoalMstController::class, 'exportktg']);
...
Route::patch('updatestatuspembayaran/{id}', [UserListController::class, 'updatestatuspembayaran'])->name('updatestatuspembayaran');
    ...
    Route::get('listtransaksi/{jenis}/export', [App\Http\Controllers\UserListController::class, 'excelTransaksi']);
