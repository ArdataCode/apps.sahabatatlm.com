...
@section('contentheadermenu')
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a class="_kembali" href="{{ url('paketsoalmst') }}"><i class="fa fa-arrow-left"
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/paketsoalktg/{{ $idpaketmst }}/export" download class="btn btn-sm btn-success"
                    ...
                    <form method="post" id="formData_{{ $key->id }}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="fk_kategori_soal_{{ $key->id }}">Kategori Soal<span
                                        class="bintang">*</span></label>
                                <input readonly type="text" class="form-control"
                                    id="fk_kategori_soal_{{ $key->id }}" name="fk_kategori_soal[]"
                                    placeholder="Kategori Soal" value="{{ $key->kategori_soal_r->judul }}">
                            </div>
                            <div class="form-group" style="display:none">
                                <label for="kkm_{{ $key->id }}">KKM Perkategori<span
                                        class="bintang">*</span></label>
                                <input type="hidden" class="form-control int" id="kkm_{{ $key->id }}"
                                    name="kkm[]" placeholder="KKM Perkategori" value="{{ $key->kkm }}"
                                    {{ $datamst->jenis_penilaian == 1 ? 'max=100' : '' }}>
                            </div>
                            <!-- /.form-group -->
                            <!-- </div> -->
                        </div>
