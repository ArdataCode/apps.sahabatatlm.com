                                                ...
                                                <td width="1%" style="text-align:right">
                                                    ...
                                                    <button onclick="modalImage('{{ $key->username }}','{{ asset($key->scan) }}')" class="btn btn-sm btn-outline-info"><i class="fas fa-eye"></i></button>
                                                        ...
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            ...
                                                            <a href="{{ url('lihattransaksi') }}/{{ Crypt::encrypt($key->id) }}"
                                                                class="btn btn-sm btn-outline-danger"><i
                                                                    class="fas fa-money"></i></a>
                                                        </span>
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            title="Lihat Hasil Ujian">
                                                            <a href="{{ url('lihathasilujian') }}/{{ Crypt::encrypt($key->id) }}"
                                                        ...
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            title="Hapus Data">
                                                            <button data-toggle="modal"
                                                                data-target="#modal-hapus-{{ $key->id }}"
                    ...
                    <form method="post" id="formData_{{ $key->id }}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            @if (Auth::user()->user_level == '1')
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="User Level"
                                        value="{{ $key->nama_level }}" readonly>
                                </div>
                            @endif
                            <div class="form-group">
                                <label>Username<span class="bintang">*</span> (Akun Login)</label>
                                <input type="text" class="form-control" placeholder="Username"
                                    value="{{ $key->username }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="name_{{ $key->id }}">Nama Lengkap<span class="bintang">*</span></label>
                                <input type="text" class="form-control" id="name_{{ $key->id }}" name="name[]"
                                    placeholder="Nama Lengkap" value="{{ $key->name }}">
                            </div>
                            <div class="form-group">
                                <label for="email_{{ $key->id }}">Email<span class="bintang">*</span></label>
                                <input type="email" class="form-control" placeholder="Email"
                                    value="{{ $key->email }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="no_wa_{{ $key->id }}">Nomor Whatsapp<span
                                        class="bintang">*</span></label>
                                <input type="text" class="form-control int" id="no_wa_{{ $key->id }}"
                                    name="no_wa[]" placeholder="Nomor Whatsapp" value="{{ $key->no_wa }}">
                            </div>
                            <div class="form-group">
                                <label for="jenis_kelamin_{{ $key->id }}">Jenis Kelamin<span
                                        class="bintang">*</span></label>
                                <select class="form-control jenis_kelamin" id="jenis_kelamin_{{ $key->id }}"
                                    name="jenis_kelamin[]">
                                    <option {{ $key->jenis_kelamin == 'l' ? 'selected' : '' }} value="l">Laki-laki
                                    </option>
                                    <option {{ $key->jenis_kelamin == 'p' ? 'selected' : '' }} value="p">Perempuan
                                    </option>
                                </select>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat[]" id="alamat_{{ $key->id }}" rows="5" class="form-control"
                                    placeholder="Alamat">{{ $key->alamat }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="provinsi_{{ $key->id }}">Provinsi<span class="bintang">*</span></label>
                                <select class="form-control form-control-lg _provinsi"
                                    id_kabupaten="kabupaten_{{ $key->id }}"
                                    id_kecamatan="kecamatan_{{ $key->id }}" id="provinsi_{{ $key->id }}"
                                    name="provinsi[]">
                                    <option value=""></option>
                                    @foreach ($provinsi as $data)
                                        <option value="{{ $data->id_prov }}"
                                            {{ $key->provinsi == $data->id_prov ? 'selected' : '' }}>{{ $data->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-lg" id="kabupaten_{{ $key->id }}"
                                    name="kabupaten[]">
                                    @php
                                    ...
                                    <option value=""></option>
                                    @foreach ($kab as $data)
                                        <option value="{{ $data->id_kab }}"
                                            {{ $key->kabupaten == $data->id_kab ? 'selected' : '' }}>{{ $data->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-lg" id="kecamatan_{{ $key->id }}"
                                    name="kecamatan[]">
                                    @php
                                    ...
                                    @foreach ($kec as $data)
                                        <option value="{{ $data->id_kec }}"
                                            {{ $key->kecamatan == $data->id_kec ? 'selected' : '' }}>{{ $data->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <div class="modal fade" id="modal-reset-{{ $key->id }}">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6> Apakah anda ingin me-reset password {{ $key->name }}? <b>(Password akan disamakan dengan
                                username)</b></h6>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
                        <button type="button" class="btn btn-danger btn-reset-pwd"
                            iduser="{{ $key->id }}">Ya</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
