        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="theme-setting-wrapper">
                <div id="settings-trigger" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <a href="https://api.whatsapp.com/send?phone={{ $template->no_hp }}&text=Halo%20Admin%20Saya%20Mau%20Bertanya"
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span
                            class="text-muted text-center text-sm-left d-block d-sm-inline-block">{{ $template->copyright }}</span>
