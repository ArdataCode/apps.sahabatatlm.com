          ...
          <div class="row mt-4 row-atas">
            ...
            <h4 class="mt-3"><b>Pilih Metode Pembayaran</b></h4>
             <div class="row">
               ...
               <div class="col-12 col-md-4 col-lg-4 d-flex align-items-stretch mt-3 hover-box" channel="{{$key->kode}}" namachannel="{{$key->nama}}">
                <div class="card w-100">
                  <div class="card-body shadow" style="min-height: 200px; padding: 1rem;border-radius:20px">
                    <div class="d-flex mb-2">
                      <div class="mr-auto text-left text-primary pr-2 payment-name">{{$key->nama}}</div>
                    </div>
                    <div class="text-center"><img src="{{$key->img}}" alt="" class="img-fluid" style="height: 35px;object-fit:contain"></div>
                  ...
                  <div class="card card-border mt-3 border-top">
                    <div class="card-body" style="text-align:left">
                      ...
                      <label for="">Nama Paket</label>
                        <input type="text" class="form-control" placeholder="Nama Paket" style="color:#A95CFF;border-color:#A95CFF" value="{{$paket->judul}}" readonly>
...
var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
  ...
  $(document).ready(function(){
          ...
          Swal.fire({
            ...
            html: "Paket : <b>{{$paket->judul}}</b><br>Total Pembayaran : <b>"+total+"</b><br>Metode Pembayaran : <b>"+namachannel+"</b>",
            // icon: 'warning',
