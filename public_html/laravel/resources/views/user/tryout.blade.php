                  ...
                  <div class="card-body">
                      ...
                      <div class="media">
                        <div class="media-body">
                          <h6 class="mb-1"><i class="far fa-sticky-note"></i> {{$key->total_soal}} Soal</h6>
                        </div>   
                        <div class="media-body">
                          <h6 class="mb-1"><i class="far fa-clock"></i> {{$key->waktu}} Menit</h6>
                        </div>
                      </div>
                    <hr>
                    <div class="mb-3">
                    ...
                    @endphp
                      ...
                      @else
                          ...
                          <button type="button" class="mt-2 btn btn-md btn-warning btn-block btn-icon-text">
                            ...
                            @else
                            <a href="{{url('rankingtryout')}}/{{Crypt::encrypt($key->id)}}" type="button" class="mt-2 btn btn-md btn-new btn-block btn-icon-text">
                              <i class="fas fa-trophy btn-icon-prepend"></i>    
                              Peringkat
                            </a>
                          @endif
